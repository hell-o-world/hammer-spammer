...
learn_doc_count=0
address="/home/sid/spam_project"

for z in glob.glob(address+"/enron1/ham/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	learning(x,0)
	learn_doc_count+=1
for z in glob.glob(address+"/enron2/ham/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	learning(x,0)
...
for z in glob.glob(address+"/enron1/spam/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	learning(x,1)
...
for z in glob.glob(address+"/enron2/spam/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	learning(x,1)
...
for z in glob.glob(address+"/enron3/ham/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	if (prediction(x)==1):
...
for z in glob.glob(address+"/enron3/spam/*.txt"):
	fname=z
	text_file=open(fname,"r")
	x=text_file.read()
	if (prediction(x)==1):
